    ...
    return (
      <div className="flex flex-col lg:flex-row min-h-screen items-center justify-center px-6 lg:px-10">
        ...
        <div className="lg:w-1/2 w-full px-6 lg:pl-10">
          ...
          {/* Add to Cart Button */}
          <button className="block lg:inline-block text-center p-2 text-sm lg:text-base px-4 py-2 rounded-full bg-black text-white hover:bg-gray-800 transition duration-300">
            Add to Cart
          </button>
        </div>
      </div>
